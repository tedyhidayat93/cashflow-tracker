...
export default function Welcome({ auth }) {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#F4F4E8] text-[#1B3022] selection:bg-[#2D5A27] selection:text-white dark:bg-[#0D1A12] dark:text-[#D1D9D0] transition-colors duration-300 relative overflow-hidden">
                ...
                {/* Navigation */}
                <nav className="fixed top-0 w-full z-50 bg-[#F4F4E8]/60 backdrop-blur-xl border-b border-[#D1D1C2] dark:bg-[#0D1A12]/60 dark:border-[#1B3022]">
                    <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                            ...
                            <span className="font-extrabold text-xl tracking-tight text-[#1B3022] dark:text-[#F4F4E8] uppercase">
                        ...
                        <div className="flex items-center gap-6 py-3">
                            {auth.user ? (
                                ...
                                <>
                                    ...
                                    <Link href={route('register')} className="text-sm font-bold bg-[#1B3022] text-[#F4F4E8] px-5 py-2.5 rounded-xl hover:bg-[#2D5A27] shadow-md transition dark:bg-[#2D5A27] dark:hover:bg-[#3D7A36]">Mulai Gratis</Link>
                                </>
                            )}
                        </div>
                    </div>
                ...
                <main className="relative pt-[7rem] pb-20 px-6 z-10">
                    <div className="max-w-5xl mx-auto text-center">
                        {/* Badge: Dollar Green */}
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#E8E8D5] border border-[#C5C5B0] dark:bg-[#1B3022] dark:border-[#2D5A27] mb-8">
                        ...
                        <h1 className="text-4xl md:text-7xl font-black capitalize mb-5 text-[#1B3022] dark:text-[#F4F4E8] leading-[1.1] tracking-tight">
                        ...
                        <p className="text-base text-[#4A5D50] dark:text-[#A8B5A7] max-w-2xl mx-auto leading-relaxed mb-7">
                            Visualisasikan arus keuangan kamu dengan sistem cerdas <span className="font-semibold text-[#1B3022] dark:text-white underline decoration-[#85BB65] underline-offset-4">CashflowTracker</span>.
                        </p>
                        ...
                        <div className="mb-6 relative max-w-full md:max-w-lg mx-auto group">
                            <div className="relative bg-[#E8E8D5]/80 dark:bg-[#15261C]/80 backdrop-blur-2xl border border-[#C5C5B0] dark:border-[#2D5A27] p-2 rounded-[2.5rem] shadow-2xl transition-transform duration-500 group-hover:scale-[1.02]">
                                <div className="grid grid-cols-3 gap-2">
                                    <div className="px-6 py-3 text-left rounded-[2rem] bg-[#F4F4E8] dark:bg-[#0D1A12] border border-[#D1D1C2] dark:border-[#1B3022] shadow-sm">
                                        <div className="text-[#4A5D50]/60 dark:text-[#85BB65]/40 font-bold uppercase text-[7px] md:text-[9px] tracking-widest">Balance</div>
                                        <AnimatedNumber value={12500000} prefix="Rp" className="text-[10px] line-clamp-1 md:text-base font-bold" colorClass="text-[#1B3022] dark:text-[#F4F4E8]" />
                                    </div>
                        ...
                        <div className="flex flex-col items-center justify-center gap-8">
                            <Link href={route('register')} className="w-full sm:w-auto px-10 py-5 bg-[#2D5A27] text-[#F4F4E8] font-black text-lg rounded-2xl shadow-2xl shadow-[#2D5A27]/30 hover:bg-[#1B3022] hover:-translate-y-1 transition-all duration-300">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-3">
                                ...
                                <span className="text-sm font-medium text-[#4A5D50] dark:text-[#85BB65]">
                                    <span className="text-[#1B3022] dark:text-white font-bold">1,00+</span> menggunakan ini.
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <footer className="py-12 border-t border-[#D1D1C2] dark:border-[#1B3022] relative z-10">
